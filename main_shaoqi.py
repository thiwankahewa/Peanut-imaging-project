...
# Main workflow
# -------------------------
def process_one_npy(npy_path: str, reg_model, yolo_model: YOLO, out_dir: str,
...
def main():
    image_path = r"C:\Users\sf38890\PhD\2_Peanut_maturity\Dataset\peanut_segmentation\26_01_16_segmentation_test\images"
    output_path = r"C:\Users\sf38890\PhD\2_Peanut_maturity\Dataset\peanut_segmentation\26_01_16_segmentation_test\output"

    # Trained YOLO seg model
    yolo_seg_model_path = r"C:\Users\sf38890\PhD\2_Peanut_maturity\Models\peanut_segmentation\26_01_26_best.pt"

    # Regression model
    reg_model_path = r"C:\Users\sf38890\PhD\2_Peanut_maturity\Models\peanut_maturity_assessment\RegRF_class5_band3_new_dataset.pkl"

    os.makedirs(output_path, exist_ok=True)

    # Load models ONCE (important for efficiency)
    reg_model = pickle.load(open(reg_model_path, "rb"))
    yolo_model = YOLO(yolo_seg_model_path)  # <-- loaded once

    npy_files = sorted([f for f in os.listdir(image_path) if f.endswith(".npy")])
    ...
    for file in npy_files:
        npy_path = os.path.join(image_path, file)
        process_one_npy(
            npy_path=npy_path,
            reg_model=reg_model,
            yolo_model=yolo_model,
